...
const EFFECTS = ['dithering','dots','edge','film-grain','flow-field','gradients','halftone-cmyk'];
...
(async () => {
  ...
  let md = '# Sweep Batch 2 — dithering, dots, edge, film-grain, flow-field, gradients, halftone-cmyk\n\n';
  md += `Date: 2026-05-13\n\n`;
  ...
  fs.writeFileSync('/Users/k3sava/projects/pixart/docs/sweep-batch-2.md', md);
  console.log('\nWrote sweep-batch-2.md with', issues.length, 'issues');
})();
